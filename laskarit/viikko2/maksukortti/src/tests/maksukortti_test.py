...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_rahaa_edullisen_lounaan_verran(self):
        self.kortti = Maksukortti(2.5)
        self.kortti.syo_edullisesti()
        self.assertEqual("Kortilla on rahaa 0.0 euroa", str(self.kortti))

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_rahaa_maukkaan_lounaan_verran(self):
